            ...
            <div className={`container-fluid bg-${props.mode}`}>
                ...
                <div className="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item mx-2 ">
                            <Link className="nav-link active fs-5" aria-current="page" to="/">Services</Link>
                        </li>
                    </ul>
                    ...
                    <div className="form-check form-switch ">
                        ...
                        <label className={`form-check-label fs-6 align-middle text-${props.mode==='light'?'dark':'light'}`} htmlFor="flexSwitchCheckDefault">Change Mode</label>
                    </div>
                </div>
            </div>
        </nav>
